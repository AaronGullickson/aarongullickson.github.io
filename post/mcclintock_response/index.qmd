...
date: '2017-08-24'
description: My attempt to resolve some confusion
categories:
- status exchange
- modeling
date-modified: '2020-04-15T09:07:34-07:00'
engine: markdown
resources:
- mcclintock_orig_table.png
- mcclintock_table.png
---
...
![extract of McClintock's original Table 7](mcclintock_orig_table.png)
...
![extract of McClintock's Table 1 from response](mcclintock_table.png)

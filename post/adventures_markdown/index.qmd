...
date-modified: '2016-12-13T11:17:18-07:00'
engine: markdown
resources:
- martable1.png
- martable2.png
...
[Here](https://aarongullickson.netlify.app/other/fullmanuscript.pdf) is an example of what a full nicely formatted manuscript would look like under the default settings. The tables were produced with the `stargazer` package. [Here](https://aarongullickson.netlify.app/other/fullmanuscript_submission.pdf) is the same manuscript but with the anonymous option turned on.
